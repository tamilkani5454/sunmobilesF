  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-gray-900 relative overflow-hidden flex-col justify-between p-16">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-orange-900/40 via-gray-900 to-gray-900"></div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50 lg:bg-white">
        ...
        >
            ...
            <form className="mt-8 space-y-6">
                ...
                <Button className="w-full bg-gray-900 hover:bg-black text-white rounded-xl py-4 text-lg font-bold shadow-xl shadow-gray-900/10 hover:shadow-gray-900/20 hover:scale-[1.01] active:scale-[0.99] transition-all">
